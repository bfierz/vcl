...
IF(OPENMP_FOUND AND VCL_OPENMP_SUPPORT)
	...
	ADD_DEFINITIONS(-DVCL_OPENMP_SUPPORT)	
ENDIF()
...
IF(VCL_VECTORIZE_AVX2)
	ADD_DEFINITIONS(-DVCL_VECTORIZE_AVX)
	ADD_DEFINITIONS(-DVCL_VECTORIZE_AVX_LEVEL_MAJOR=2)
	ADD_DEFINITIONS(-DVCL_VECTORIZE_AVX_LEVEL_MINOR=0)
ELSEIF(VCL_VECTORIZE_AVX)
	ADD_DEFINITIONS(-DVCL_VECTORIZE_AVX)
	ADD_DEFINITIONS(-DVCL_VECTORIZE_AVX_LEVEL_MAJOR=1)
	ADD_DEFINITIONS(-DVCL_VECTORIZE_AVX_LEVEL_MINOR=0)
ENDIF()

IF(VCL_VECTORIZE_SSE4_2)
	ADD_DEFINITIONS(-DVCL_VECTORIZE_SSE)
	ADD_DEFINITIONS(-DVCL_VECTORIZE_SSE_LEVEL_MAJOR=4)
	ADD_DEFINITIONS(-DVCL_VECTORIZE_SSE_LEVEL_MINOR=2)
ELSEIF(VCL_VECTORIZE_SSE4_1)
	ADD_DEFINITIONS(-DVCL_VECTORIZE_SSE)
	ADD_DEFINITIONS(-DVCL_VECTORIZE_SSE_LEVEL_MAJOR=4)
	ADD_DEFINITIONS(-DVCL_VECTORIZE_SSE_LEVEL_MINOR=1)
ELSEIF(VCL_VECTORIZE_SSSE3)
	ADD_DEFINITIONS(-DVCL_VECTORIZE_SSE)
	ADD_DEFINITIONS(-DVCL_VECTORIZE_SSE_LEVEL_MAJOR=3)
	ADD_DEFINITIONS(-DVCL_VECTORIZE_SSE_LEVEL_MINOR=1)
ELSEIF(VCL_VECTORIZE_SSE3)
	ADD_DEFINITIONS(-DVCL_VECTORIZE_SSE)
	ADD_DEFINITIONS(-DVCL_VECTORIZE_SSE_LEVEL_MAJOR=3)
	ADD_DEFINITIONS(-DVCL_VECTORIZE_SSE_LEVEL_MINOR=0)
ELSEIF(VCL_VECTORIZE_SSE2)
	ADD_DEFINITIONS(-DVCL_VECTORIZE_SSE)
	ADD_DEFINITIONS(-DVCL_VECTORIZE_SSE_LEVEL_MAJOR=2)
	ADD_DEFINITIONS(-DVCL_VECTORIZE_SSE_LEVEL_MINOR=0)
ENDIF()
