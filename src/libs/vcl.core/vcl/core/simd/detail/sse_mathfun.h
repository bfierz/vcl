...
_PS_CONST_TYPE(min_norm_pos, unsigned int, 0x00800000u);
_PS_CONST_TYPE(mant_mask, unsigned int, 0x7f800000u);
_PS_CONST_TYPE(inv_mant_mask, unsigned int, ~0x7f800000u);

_PS_CONST_TYPE(sign_mask, unsigned int, 0x80000000u);
_PS_CONST_TYPE(inv_sign_mask, unsigned int, ~0x80000000u);
