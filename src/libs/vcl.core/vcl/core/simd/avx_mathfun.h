...
inline v8sf log256_ps(v8sf x)
{
  ...
  imm0 = _mmREF_srli_epi32(_mm256_castps_si256(x), 23);
  ...
  imm0 = _mmREF_sub_epi32(imm0, *(v8si*)_pi32_256_0x7f);
...
v8sf exp256_ps(v8sf x) {
  ...
  imm0 = _mmREF_add_epi32(imm0, *(v8si*)_pi32_256_0x7f);
  imm0 = _mmREF_slli_epi32(imm0, 23);
